...
inline void ListAllTrainImgFilenames(AppContextCellDetClass* apphp, std::vector<boost::filesystem::path>& trainImgFilenames){
    trainImgFilenames.clear();
    ls(apphp->path_traindata, ".*png", trainImgFilenames);
}

inline void ListAllTestImgFilenames(AppContextCellDetClass* apphp, std::vector<boost::filesystem::path>& testImgFilenames){
    testImgFilenames.clear();
    ls(apphp->path_testdata, ".*png", testImgFilenames);
}

inline void ExtendBorder(AppContextCellDetClass* apphp, cv::Mat& src_img, cv::Mat& dst_img, bool rgb){
